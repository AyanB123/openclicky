...
nonisolated enum AppBundleConfiguration {
    ...
    static let userLocalSpeechModelDefaultsKey = "openClickyLocalSpeechModelID"
    static let userLocalBrainModelDefaultsKey = "openClickyLocalBrainModelID"
    static let userRuntimeLabVisibleDefaultsKey = "openClickyRuntimeLabVisible"
