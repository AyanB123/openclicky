...
- Create or update learned skills only when the user asks for skill/log learning or when a repeated workflow would materially speed up future work. Use curated names and specific trigger descriptions; do not create request-shaped `workflow_*` skills. Do not mention skill checks or skill creation in progress or final answers unless asked.
